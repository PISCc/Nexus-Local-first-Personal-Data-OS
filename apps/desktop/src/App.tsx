...
type RescanSummary = RescanProgress & {
...
> = {
  idle: { label: "等待开始", title: "输入目录后开始一次本地元数据重扫。" },
  starting: { label: "准备中", title: "正在准备本地重扫任务。" },
  running: { label: "扫描中", title: "正在扫描文件元数据。" },
  cancelling: { label: "取消中", title: "正在停止本地重扫。" },
  completed: { label: "已完成", title: "本次手动重扫已完成。" },
  cancelled: { label: "已取消", title: "本次手动重扫已取消。" },
  failed: { label: "未完成", title: "本次手动重扫未完成。" },
};
        ...
        <div className="content-wrap">
          <section className="hero" aria-labelledby="hero-title">
            <div className="hero-copy">
              <p className="eyebrow">Nexus / M1 文件索引</p>
              <h1 id="hero-title">
                个人数据，
                <span>留在身边。</span>
              </h1>
          ...
          <section className="rescan-workspace" aria-labelledby="rescan-title">
            ...
            <div className="rescan-card">
              <div className="rescan-card-header">
                <div>
                  <span className="rescan-card-index">01 / 文件元数据</span>
                  <h3>建立可检索的文件清单</h3>
                </div>
                <div
                  ...
                  <input
                    ...
                    onChange={(event) => {
                      ...
                      if (rescanPhase === "failed") {
                        ...
                        setRescanPhase("idle");
                        setRescanMessage(rescanPhasePresentation.idle.title);
                      }
                    }}
              ...
              <div className="scan-progress-block" aria-live="polite">
                <div className="scan-progress-heading">
                  ...
                  <strong>{formatCount(progress.processed)} 项已处理</strong>
                </div>
                <div
              ...
              {summary !== null && rescanPhase === "completed" ? (
                <div className="scan-result" aria-label="重扫结果">
                  ...
                  <div className="result-grid">
                    ...
                    <div>
                      <span>已提交批次</span>
                      <strong>{formatCount(summary.batchesCommitted)}</strong>
                    </div>
                  </div>
                </div>
              ) : null}
          ...
          <section className="next-step" aria-label="下一里程碑">
            <div>
              ...
              <strong>M2 / 内容解析</strong>
            </div>
            <span className="next-step-copy">先读懂文档，再建立全文搜索。</span>
